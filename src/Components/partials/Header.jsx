  ...
  return (
    ...
    >
      ...
      <Link  to={`/${data.media_type}/details/${data.id}/trailer`}
        className="mt-6 group px-6 py-2 bg-[#6556cd] hover:bg-black hover:border-2 hover:border-zinc-600 text-white font-semibold text-lg rounded-lg shadow-md transition duration-300"
      >
        <i className="group-hover:text-red-500  text-xl ri-play-fill mr-2"></i> Watch Trailer
      </Link>
    </div>
  );
};
